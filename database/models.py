...
class Buyer(db.Model):
    ...
    last_name = db.Column(
        ...
        nullable=False)
    phone_number = db.Column(db.VARCHAR(length=50), nullable=False)
...
class PaymentMethod(db.Model):
    ...
    buyer = db.relationship('Buyer', backref='payment_method')

    billing_address = db.Column(
        db.VARCHAR(100),
        db.CheckConstraint(slqtext="billing_address ~ '[\sA-Za-z0-9.]+'", name='billing_address'),
        nullable=True)
    ...
    year_exp = db.Column(
        ...
        default=False,
        nullable=False)
    internal_payment_method = db.Column(db.BOOLEAN, default=False, nullable=False)
    external_payment_method = db.Column(db.Boolean, default=False, nullable=False)
    active = db.Column(db.BOOLEAN, default=True, nullable=False)
    ...
    def __init__(self,
                 ...
                 month_exp: int = None,
                 year_exp: int = None,
                 internal_payment_method:bool = None,
                 external_payment_method:bool = None,
                 active: bool = None):
    ...
    def __repr__(self):
        return 'PaymentMethod(id=%r,' \
               ...
               self.year_exp, self.internal_payment_method,\
               self.external_payment_method, self.active
...
class City(db.Model):
    ...
    def __repr__(self):
        return 'City(id=%r, city=%r)' % self.id, self.city
